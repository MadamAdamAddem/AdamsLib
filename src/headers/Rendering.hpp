...
public:
  ...
  void render(int x, int y, SDL_Renderer* renderer, double renderScale = 1.0f, SDL_Rect* clip = nullptr, SDL_Rect* rSpace = nullptr, double angle = 0.0, SDL_Point center = {0,0}, SDL_Color colorMod = {0,0,0,0});
